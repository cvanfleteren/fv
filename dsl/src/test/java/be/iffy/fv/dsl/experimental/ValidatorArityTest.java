...
class ValidatorArityTest {
    ...
    class Validator1 {
        ...
        void builds_withOneValidField_returnsValid() {
            ...
            assertThatValidation(validator.apply(input)).isValid().isEqualTo("v1");
        }
    }
    ...
    class Validator2 {
        ...
        void builds_withTwoValidFields_returnsValid() {
            ...
            assertThatValidation(validator.apply(input)).isValid().isEqualTo("v1v2");
        }
    }
    ...
    class Validator3 {
        ...
        void builds_withThreeValidFields_returnsValid() {
            ...
            assertThatValidation(validator.apply(input)).isValid().isEqualTo("v1v2v3");
        }
    }
    ...
    class Validator4 {
        ...
        void builds_withFourValidFields_returnsValid() {
            ...
            assertThatValidation(validator.apply(input)).isValid().isEqualTo("v1v2v3v4");
        }
    }
    ...
    class Validator5 {
        ...
        void builds_withFiveValidFields_returnsValid() {
            ...
            assertThatValidation(validator.apply(input)).isValid().isEqualTo("v1v2v3v4v5");
        }
    }
    ...
    class Validator6 {
        ...
        void builds_withSixValidFields_returnsValid() {
            ...
            assertThatValidation(validator.apply(input)).isValid().isEqualTo("v1v2v3v4v5v6");
        }
    }
    ...
    class Validator7 {
        ...
        void builds_withSevenValidFields_returnsValid() {
            ...
            assertThatValidation(validator.apply(input)).isValid().isEqualTo("v1v2v3v4v5v6v7");
        }
    }
    ...
    class Validator8 {
        ...
        void builds_withEightValidFields_returnsValid() {
            ...
            assertThatValidation(validator.apply(input)).isValid().isEqualTo("v1v2v3v4v5v6v7v8");
        }
    }
}
