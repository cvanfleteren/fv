...
public class ValidatingDSL {
    ...
    public static class ValidatingBuilder2<T1, T2> {
        ...
        /**
         * Maps the values of the passed Validations if they are {@link net.vanfleteren.fv.Validation.Valid}
         *
         ...
         * @return a {@code Validation<T>} containing the transformed result, or an {@link net.vanfleteren.fv.Validation.Invalid} if either validation fails
         */
        ...
        /**
         * FlatMaps the values of the passed Validations if they are {@link net.vanfleteren.fv.Validation.Valid}
         *
         * @param mapper a function that takes two inputs of types T1 and T2 and produces a {@code Validation} of type T
         * @param <T> the type of the resulting validation value
         * @return a {@code Validation<T>} containing the transformed result, or an {@link net.vanfleteren.fv.Validation.Invalid} if any of the input validations fail
         */
