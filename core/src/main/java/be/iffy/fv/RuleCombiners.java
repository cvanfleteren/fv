...
public class RuleCombiners {
     ...
     */
   public static <T, R1, R2> CombineBuilder2<T, R1, R2> combine(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2) {
     ...
     */
   public static <T, R1, R2, R3> CombineBuilder3<T, R1, R2, R3> combine(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3) {
     ...
     */
   public static <T, R1, R2, R3, R4> CombineBuilder4<T, R1, R2, R3, R4> combine(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4) {
     ...
     */
   public static <T, R1, R2, R3, R4, R5> CombineBuilder5<T, R1, R2, R3, R4, R5> combine(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4, RuleLike<? super T, Validation<R5>> r5) {
     ...
     */
   public static <T, R1, R2, R3, R4, R5, R6> CombineBuilder6<T, R1, R2, R3, R4, R5, R6> combine(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4, RuleLike<? super T, Validation<R5>> r5, RuleLike<? super T, Validation<R6>> r6) {
     ...
     */
   public static <T, R1, R2, R3, R4, R5, R6, R7> CombineBuilder7<T, R1, R2, R3, R4, R5, R6, R7> combine(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4, RuleLike<? super T, Validation<R5>> r5, RuleLike<? super T, Validation<R6>> r6, RuleLike<? super T, Validation<R7>> r7) {
     ...
     */
   public static <T, R1, R2, R3, R4, R5, R6, R7, R8> CombineBuilder8<T, R1, R2, R3, R4, R5, R6, R7, R8> combine(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4, RuleLike<? super T, Validation<R5>> r5, RuleLike<? super T, Validation<R6>> r6, RuleLike<? super T, Validation<R7>> r7, RuleLike<? super T, Validation<R8>> r8) {
        return new CombineBuilder8<>(r1, r2, r3, r4, r5, r6, r7, r8);
    }

    public record CombineBuilder2<T, R1, R2>(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2) {
   ...
   public record CombineBuilder3<T, R1, R2, R3>(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3) {
   ...
   public record CombineBuilder4<T, R1, R2, R3, R4>(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4) {
   ...
   public record CombineBuilder5<T, R1, R2, R3, R4, R5>(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4, RuleLike<? super T, Validation<R5>> r5) {
   ...
   public record CombineBuilder6<T, R1, R2, R3, R4, R5, R6>(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4, RuleLike<? super T, Validation<R5>> r5, RuleLike<? super T, Validation<R6>> r6) {
   ...
   public record CombineBuilder7<T, R1, R2, R3, R4, R5, R6, R7>(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4, RuleLike<? super T, Validation<R5>> r5, RuleLike<? super T, Validation<R6>> r6, RuleLike<? super T, Validation<R7>> r7) {
   ...
   public record CombineBuilder8<T, R1, R2, R3, R4, R5, R6, R7, R8>(RuleLike<? super T, Validation<R1>> r1, RuleLike<? super T, Validation<R2>> r2, RuleLike<? super T, Validation<R3>> r3, RuleLike<? super T, Validation<R4>> r4, RuleLike<? super T, Validation<R5>> r5, RuleLike<? super T, Validation<R6>> r6, RuleLike<? super T, Validation<R7>> r7, RuleLike<? super T, Validation<R8>> r8) {
