...
public class Validations {
     ...
     */
    public static <T> Validation<T> fromCatching(Supplier<? extends T> supplier) {
     ...
     */
    public static <T> Validation<T> fromCatchingAll(Supplier<? extends T> supplier, Function<Exception, ErrorMessage> errorMessageMaker) {
        Objects.requireNonNull(supplier, "supplier cannot be null");
     ...
     */
    public static <T> Validation<T> fromCatchingAll(Supplier<? extends T> supplier, ErrorMessage errorMessage) {
     ...
     * as it can hide issues like {@link NullPointerException} and so on.
     */
    public static <T> Validation<T> fromCatchingAll(Supplier<? extends T> supplier, String errorKey) {
     ...
     */
    public static <T> Validation<T> from(Try<? extends T> _try, ErrorMessage errorMessage) {
     ...
     * If the {@link Try} is failed, the returned validation will be invalid with the provided error message.
     */
    public static <T> Validation<T> from(Try<? extends T> _try, String errorKey) {
     ...
     */
    public static <T> Validation<T> from(Try<? extends T> _try) {
        Objects.requireNonNull(_try, "_try cannot be null");
        return _try.fold(
     ...
     */
    public static <T> Validation<T> from(Option<? extends T> option, ErrorMessage errorMessage) {
        Objects.requireNonNull(option, "option cannot be null");
        Objects.requireNonNull(errorMessage, "errorMessage cannot be null");
        return option.fold(
     ...
     */
    public static <T> Validation<T> from(Option<? extends T> option, String errorKey) {
        Objects.requireNonNull(option, "option cannot be null");
     ...
     */
    public static <T> Validation<T> from(Option<? extends T> option) {
        Objects.requireNonNull(option, "option cannot be null");
     ...
     */
    public static <L, R> Validation<R> from(Either<L, ? extends R> either, Function1<? super L, ErrorMessage> errorMapper) {
     ...
     *
     */
    public static <T> Validation<T> from(Optional<? extends T> optional) {
        Objects.requireNonNull(optional, "optional cannot be null");
     ...
     */
    public static <T> Validation<T> from(Optional<? extends T> optional, String errorKey) {
        Objects.requireNonNull(optional, "optional cannot be null");
     ...
     */
    public static <T> Validation<T> from(Optional<? extends T> optional, ErrorMessage errorMessage) {
        Objects.requireNonNull(optional, "optional cannot be null");
        Objects.requireNonNull(errorMessage, "errorMessage cannot be null");
