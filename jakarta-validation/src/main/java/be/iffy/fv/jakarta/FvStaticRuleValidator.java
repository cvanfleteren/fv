...
/**
 * BV {@link jakarta.validation.ConstraintValidator} that resolves an FV {@link Rule} from a preferable {@code public},
 * {@code static} field on a class, as specified by {@link FvStaticRule}.
 */
